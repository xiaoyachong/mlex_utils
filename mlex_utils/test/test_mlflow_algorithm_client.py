...
from mlex_utils.test.test_utils import mlflow_test_algorithm_client, mock_mlflow_algorithm_client, mock_os_makedirs
...
class TestMlflowAlgorithmClient:
    ...
    def test_check_mlflow_ready_success(self, mlflow_test_algorithm_client, mock_mlflow_algorithm_client):
        ...
        mock_mlflow_algorithm_client.search_experiments.assert_called_once_with(max_results=1)

    def test_check_mlflow_ready_failure(self, mlflow_test_algorithm_client, mock_mlflow_algorithm_client):
    ...
    def test_getitem_failure(self, mlflow_test_algorithm_client):
        ...
        assert "An algorithm with name 'missing_algo' does not exist" in str(exc_info.value)

    def test_load_from_mlflow_success(self, mlflow_test_algorithm_client, mock_mlflow_algorithm_client):
        ...
        mock_mlflow_algorithm_client.search_registered_models.return_value = [mock_model]
    ...
    def test_load_from_mlflow_no_algorithms(self, mlflow_test_algorithm_client, mock_mlflow_algorithm_client):
    ...
    def test_register_algorithm_success(self, mlflow_test_algorithm_client, mock_mlflow_algorithm_client):
    ...
    def test_register_algorithm_already_exists(self, mlflow_test_algorithm_client, mock_mlflow_algorithm_client):
    ...
    def test_register_algorithm_no_model_name(self, mlflow_test_algorithm_client):
        ...
        assert "Algorithm configuration must include 'model_name'" in str(exc_info.value)